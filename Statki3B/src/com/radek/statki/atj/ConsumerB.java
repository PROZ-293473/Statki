...
public class ConsumerB {
	...
	public ConsumerB(String url, String queueName, GameModel gm) throws JMSException {
		this.gm = gm;
	...
	public void receiveQueueMessageAsync() throws InterruptedException {
		jmsConsumer.setMessageListener(new AsynchConsumerB(gm));
		for (int i = 0; i < 30; ++i) { // 30 sekund
			System.out.println("Konsument B wykonuje zadanie");
			Thread.sleep(100);
		}
	}
